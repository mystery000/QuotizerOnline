...
<head>
  ...
  <style>
    body {
        background-image: url(./assets/pix/bg/infinity-scenario-background-stars2-logo-1920x2880.jpg) !important;
            ...
            <div class="carousel-inner">
                <?php 
                    ...
                    foreach($images as $image) {
                        echo '<div class="carousel-item '.$isFirstSlide.'" data-bs-interval="3000"><img src="'.$image.'" alt="no image"></div>';
                        $isFirstSlide = '';
                    }
